# AI Repository Guide — Essentials
...
This repository is reviewed as **framework library and application infrastructure**. This guide explains how an AI agent should inspect and change its source without relying on undocumented assumptions.
