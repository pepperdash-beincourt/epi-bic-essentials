...
| Source file | [`src/PepperDash.Essentials.Core/Touchpanels/Interfaces.cs`](../../../src/PepperDash.Essentials.Core/Touchpanels/Interfaces.cs) |
| Language | C# |
| Declaration | `interface IHasBasicTriListWithSmartObject` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`IHasBasicTriListWithSmartObject` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
