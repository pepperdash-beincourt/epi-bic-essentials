...
| Source file | [`src/PepperDash.Essentials.Core/Bridges/JoinMaps/GenericRelayControllerJoinMap.cs`](../../../src/PepperDash.Essentials.Core/Bridges/JoinMaps/GenericRelayControllerJoinMap.cs) |
| Language | C# |
| Declaration | `class GenericRelayControllerJoinMap` with declared base/contract list `JoinMapBaseAdvanced` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Bridges` |

## What

`GenericRelayControllerJoinMap` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
