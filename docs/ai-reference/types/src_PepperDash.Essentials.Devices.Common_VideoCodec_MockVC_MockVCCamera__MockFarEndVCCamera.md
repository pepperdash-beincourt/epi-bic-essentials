...
| Language | C# |
| Declaration | `class MockFarEndVCCamera` with declared base/contract list `CameraBase, IHasCameraPtzControl, IAmFarEndCamera, IBridgeAdvanced` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Cameras` |

## What

`MockFarEndVCCamera` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
