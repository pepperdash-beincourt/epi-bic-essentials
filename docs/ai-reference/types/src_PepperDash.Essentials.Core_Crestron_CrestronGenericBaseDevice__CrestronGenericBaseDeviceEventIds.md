# CrestronGenericBaseDeviceEventIds
...
| Language | C# |
| Declaration | `class CrestronGenericBaseDeviceEventIds` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`CrestronGenericBaseDeviceEventIds` is a device-model type that owns lifecycle, controls, feedback, or communication responsibilities. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
