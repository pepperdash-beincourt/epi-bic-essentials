...
| Source file | [`src/PepperDash.Essentials.Core/UI PageManagers/SetTopBoxTwoPanelPageManager.cs`](../../../src/PepperDash.Essentials.Core/UI PageManagers/SetTopBoxTwoPanelPageManager.cs) |
| Language | C# |
| Declaration | `class SetTopBoxMediumPageManager` with declared base/contract list `MediumLeftSwitchablePageManager` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.PageManagers` |

## What

`SetTopBoxMediumPageManager` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
