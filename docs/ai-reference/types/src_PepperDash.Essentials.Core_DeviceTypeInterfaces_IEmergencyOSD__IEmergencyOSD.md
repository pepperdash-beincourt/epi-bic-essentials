...
| Source file | [`src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IEmergencyOSD.cs`](../../../src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IEmergencyOSD.cs) |
| Language | C# |
| Declaration | `interface IEmergencyOSD` |
| Accessibility | `public` |
| Namespace/module | `Global namespace` |

## What

`IEmergencyOSD` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
