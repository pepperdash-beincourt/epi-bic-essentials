...
| Source file | [`src/PepperDash.Essentials.Core/Routing/RoutingPortNames.cs`](../../../src/PepperDash.Essentials.Core/Routing/RoutingPortNames.cs) |
| Language | C# |
| Declaration | `class RoutingPortNames` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`RoutingPortNames` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
