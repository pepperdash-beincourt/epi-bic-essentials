...
| Source file | [`src/PepperDash.Essentials.Devices.Common/VideoCodec/ConvertiblePreset.cs`](../../../src/PepperDash.Essentials.Devices.Common/VideoCodec/ConvertiblePreset.cs) |
| Language | C# |
| Declaration | `class ConvertiblePreset` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.VideoCodec` |

## What

`ConvertiblePreset` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `ConvertCodecPreset`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
