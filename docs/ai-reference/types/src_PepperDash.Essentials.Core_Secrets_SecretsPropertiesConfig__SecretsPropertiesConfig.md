...
| Source file | [`src/PepperDash.Essentials.Core/Secrets/SecretsPropertiesConfig.cs`](../../../src/PepperDash.Essentials.Core/Secrets/SecretsPropertiesConfig.cs) |
| Language | C# |
| Declaration | `class SecretsPropertiesConfig` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`SecretsPropertiesConfig` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
