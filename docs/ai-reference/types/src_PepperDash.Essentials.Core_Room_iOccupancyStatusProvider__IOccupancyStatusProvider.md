...
| Source file | [`src/PepperDash.Essentials.Core/Room/iOccupancyStatusProvider.cs`](../../../src/PepperDash.Essentials.Core/Room/iOccupancyStatusProvider.cs) |
| Language | C# |
| Declaration | `interface IOccupancyStatusProvider` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`IOccupancyStatusProvider` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
