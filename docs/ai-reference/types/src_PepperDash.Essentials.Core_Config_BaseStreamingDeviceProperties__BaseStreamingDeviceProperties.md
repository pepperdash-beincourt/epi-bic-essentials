...
| Source file | [`src/PepperDash.Essentials.Core/Config/BaseStreamingDeviceProperties.cs`](../../../src/PepperDash.Essentials.Core/Config/BaseStreamingDeviceProperties.cs) |
| Language | C# |
| Declaration | `class BaseStreamingDeviceProperties` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Config` |

## What

`BaseStreamingDeviceProperties` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
