# IHasCamerasWithControlsStateMessage
...
| Source file | [`src/PepperDash.Essentials.MobileControl.Messengers/Messengers/IHasCamerasWithControlsMessenger.cs`](../../../src/PepperDash.Essentials.MobileControl.Messengers/Messengers/IHasCamerasWithControlsMessenger.cs) |
| Language | C# |
| Declaration | `class IHasCamerasWithControlsStateMessage` with declared base/contract list `DeviceStateMessageBase` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.AppServer.Messengers` |

## What

`IHasCamerasWithControlsStateMessage` is a structured representation of data exchanged between components. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
