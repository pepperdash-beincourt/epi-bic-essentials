...
| Source file | [`src/PepperDash.Essentials.Devices.Common/VideoCodec/CiscoCodec/eCommandType.cs`](../../../src/PepperDash.Essentials.Devices.Common/VideoCodec/CiscoCodec/eCommandType.cs) |
| Language | C# |
| Declaration | `enum eCommandType` |
| Accessibility | `unspecified` |
| Namespace/module | `Global namespace` |

## What

`eCommandType` is a finite set of symbolic states or options used by the surrounding implementation. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
