...
| Language | C# |
| Declaration | `class MessengerFactoryRegistry` |
| Accessibility | `internal` |
| Namespace/module | `PepperDash.Essentials` |

## What

`MessengerFactoryRegistry` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
