# IEssentialsRoomFusionControllerFactory
...
| Source file | [`src/PepperDash.Essentials.Core/Fusion/IEssentialsRoomFusionControllerFactory.cs`](../../../src/PepperDash.Essentials.Core/Fusion/IEssentialsRoomFusionControllerFactory.cs) |
| Language | C# |
| Declaration | `class IEssentialsRoomFusionControllerFactory` with declared base/contract list `EssentialsDeviceFactory<IEssentialsRoomFusionController>` |
| Accessibility | `public` |
| Namespace/module | `Global namespace` |

## What

`IEssentialsRoomFusionControllerFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
