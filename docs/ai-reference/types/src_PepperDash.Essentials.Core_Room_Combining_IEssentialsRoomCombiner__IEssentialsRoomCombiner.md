...
| Source file | [`src/PepperDash.Essentials.Core/Room/Combining/IEssentialsRoomCombiner.cs`](../../../src/PepperDash.Essentials.Core/Room/Combining/IEssentialsRoomCombiner.cs) |
| Language | C# |
| Declaration | `interface IEssentialsRoomCombiner` with declared base/contract list `IKeyed` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`IEssentialsRoomCombiner` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
