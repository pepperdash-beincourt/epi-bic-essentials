...
| Source file | [`src/PepperDash.Essentials.Devices.Common/VideoCodec/Interfaces/IHasMeetingLock.cs`](../../../src/PepperDash.Essentials.Devices.Common/VideoCodec/Interfaces/IHasMeetingLock.cs) |
| Language | C# |
| Declaration | `interface IHasMeetingLock` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.VideoCodec.Interfaces` |

## What

`IHasMeetingLock` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
