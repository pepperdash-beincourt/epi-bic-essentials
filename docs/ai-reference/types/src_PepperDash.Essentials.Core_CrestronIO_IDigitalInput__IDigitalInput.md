...
| Source file | [`src/PepperDash.Essentials.Core/CrestronIO/IDigitalInput.cs`](../../../src/PepperDash.Essentials.Core/CrestronIO/IDigitalInput.cs) |
| Language | C# |
| Declaration | `interface IDigitalInput` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.CrestronIO` |

## What

`IDigitalInput` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
