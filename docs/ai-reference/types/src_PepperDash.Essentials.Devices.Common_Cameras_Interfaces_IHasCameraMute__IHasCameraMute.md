...
| Source file | [`src/PepperDash.Essentials.Devices.Common/Cameras/Interfaces/IHasCameraMute.cs`](../../../src/PepperDash.Essentials.Devices.Common/Cameras/Interfaces/IHasCameraMute.cs) |
| Language | C# |
| Declaration | `interface IHasCameraMute` with declared base/contract list `IKeyName` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Cameras` |

## What

`IHasCameraMute` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
