...
| Source file | [`src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IInitializationExceptions.cs`](../../../src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IInitializationExceptions.cs) |
| Language | C# |
| Declaration | `interface IInitializationExceptions` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.DeviceTypeInterfaces` |

## What

`IInitializationExceptions` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
