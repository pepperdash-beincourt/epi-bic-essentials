...
| Source file | [`src/PepperDash.Essentials.Core/Bridges/JoinMaps/IRBlurayBaseJoinMap.cs`](../../../src/PepperDash.Essentials.Core/Bridges/JoinMaps/IRBlurayBaseJoinMap.cs) |
| Language | C# |
| Declaration | `class IRBlurayBaseJoinMap` with declared base/contract list `JoinMapBaseAdvanced` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Bridges` |

## What

`IRBlurayBaseJoinMap` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
