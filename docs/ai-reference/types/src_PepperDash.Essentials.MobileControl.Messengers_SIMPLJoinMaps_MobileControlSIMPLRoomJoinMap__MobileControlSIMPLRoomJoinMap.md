...
| Source file | [`src/PepperDash.Essentials.MobileControl.Messengers/SIMPLJoinMaps/MobileControlSIMPLRoomJoinMap.cs`](../../../src/PepperDash.Essentials.MobileControl.Messengers/SIMPLJoinMaps/MobileControlSIMPLRoomJoinMap.cs) |
| Language | C# |
| Declaration | `class MobileControlSIMPLRoomJoinMap` with declared base/contract list `JoinMapBaseAdvanced` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.AppServer` |

## What

`MobileControlSIMPLRoomJoinMap` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
