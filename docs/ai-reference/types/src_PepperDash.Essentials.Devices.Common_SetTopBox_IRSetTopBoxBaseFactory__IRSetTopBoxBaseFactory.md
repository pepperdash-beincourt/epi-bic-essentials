...
| Source file | [`src/PepperDash.Essentials.Devices.Common/SetTopBox/IRSetTopBoxBaseFactory.cs`](../../../src/PepperDash.Essentials.Devices.Common/SetTopBox/IRSetTopBoxBaseFactory.cs) |
| Language | C# |
| Declaration | `class IRSetTopBoxBaseFactory` with declared base/contract list `EssentialsDeviceFactory<IRSetTopBoxBase>` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common` |

## What

`IRSetTopBoxBaseFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Preserve the declared inheritance/contract relationship: `EssentialsDeviceFactory<IRSetTopBoxBase>`. Public methods declared in this source file include: `BuildDevice`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
