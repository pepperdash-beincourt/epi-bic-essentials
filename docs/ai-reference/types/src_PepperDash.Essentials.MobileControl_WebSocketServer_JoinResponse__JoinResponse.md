...
| Source file | [`src/PepperDash.Essentials.MobileControl/WebSocketServer/JoinResponse.cs`](../../../src/PepperDash.Essentials.MobileControl/WebSocketServer/JoinResponse.cs) |
| Language | C# |
| Declaration | `class JoinResponse` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.WebSocketServer` |

## What

`JoinResponse` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
