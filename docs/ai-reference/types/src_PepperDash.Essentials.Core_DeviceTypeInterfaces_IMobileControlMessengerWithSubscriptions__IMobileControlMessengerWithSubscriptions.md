# IMobileControlMessengerWithSubscriptions
...
| Source file | [`src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IMobileControlMessengerWithSubscriptions.cs`](../../../src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IMobileControlMessengerWithSubscriptions.cs) |
| Language | C# |
| Declaration | `interface IMobileControlMessengerWithSubscriptions` with declared base/contract list `IMobileControlMessenger` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.DeviceTypeInterfaces` |

## What

`IMobileControlMessengerWithSubscriptions` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Preserve the declared inheritance/contract relationship: `IMobileControlMessenger`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
