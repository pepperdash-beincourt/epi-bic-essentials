# MediumLeftSwitchablePageManager
...
| Language | C# |
| Declaration | `class MediumLeftSwitchablePageManager` with declared base/contract list `PageManager` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.PageManagers` |

## What

`MediumLeftSwitchablePageManager` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
