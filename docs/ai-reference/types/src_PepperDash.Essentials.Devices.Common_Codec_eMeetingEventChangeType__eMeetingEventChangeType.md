...
| Source file | [`src/PepperDash.Essentials.Devices.Common/Codec/eMeetingEventChangeType.cs`](../../../src/PepperDash.Essentials.Devices.Common/Codec/eMeetingEventChangeType.cs) |
| Language | C# |
| Declaration | `enum eMeetingEventChangeType` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Codec` |

## What

`eMeetingEventChangeType` is a finite set of symbolic states or options used by the surrounding implementation. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
