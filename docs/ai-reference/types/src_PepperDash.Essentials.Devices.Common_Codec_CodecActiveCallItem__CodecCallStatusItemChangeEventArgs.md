# CodecCallStatusItemChangeEventArgs
...
| Source file | [`src/PepperDash.Essentials.Devices.Common/Codec/CodecActiveCallItem.cs`](../../../src/PepperDash.Essentials.Devices.Common/Codec/CodecActiveCallItem.cs) |
| Language | C# |
| Declaration | `class CodecCallStatusItemChangeEventArgs` with declared base/contract list `EventArgs` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Codec` |

## What

`CodecCallStatusItemChangeEventArgs` is an event payload type that carries state-change information between collaborators. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
