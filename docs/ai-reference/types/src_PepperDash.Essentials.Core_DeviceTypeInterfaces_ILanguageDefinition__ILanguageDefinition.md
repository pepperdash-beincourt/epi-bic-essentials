...
| Source file | [`src/PepperDash.Essentials.Core/DeviceTypeInterfaces/ILanguageDefinition.cs`](../../../src/PepperDash.Essentials.Core/DeviceTypeInterfaces/ILanguageDefinition.cs) |
| Language | C# |
| Declaration | `interface ILanguageDefinition` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.DeviceTypeInterfaces` |

## What

`ILanguageDefinition` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
