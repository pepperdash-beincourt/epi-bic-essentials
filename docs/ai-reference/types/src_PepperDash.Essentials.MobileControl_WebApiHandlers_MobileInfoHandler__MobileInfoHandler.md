...
| Source file | [`src/PepperDash.Essentials.MobileControl/WebApiHandlers/MobileInfoHandler.cs`](../../../src/PepperDash.Essentials.MobileControl/WebApiHandlers/MobileInfoHandler.cs) |
| Language | C# |
| Declaration | `class MobileInfoHandler` with declared base/contract list `WebApiBaseRequestHandler` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.WebApiHandlers` |

## What

`MobileInfoHandler` is a structured representation of data exchanged between components. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
