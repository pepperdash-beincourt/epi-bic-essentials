...
| Language | C# |
| Declaration | `class InMemoryCrestronDataStore` with declared base/contract list `ICrestronDataStore` |
| Accessibility | `internal` |
| Namespace/module | `PepperDash.Essentials.Tests.Fakes` |

## What

`InMemoryCrestronDataStore` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
