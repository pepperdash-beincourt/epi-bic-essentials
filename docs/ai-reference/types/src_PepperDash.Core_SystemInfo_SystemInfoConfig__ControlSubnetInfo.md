...
| Language | C# |
| Declaration | `class ControlSubnetInfo` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Core.SystemInfo` |

## What

`ControlSubnetInfo` is a structured representation of data exchanged between components. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
