...
| Language | C# |
| Declaration | `class RelayControlledShade` with declared base/contract list `ShadeBase, IShadesOpenCloseStop` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Shades` |

## What

`RelayControlledShade` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
