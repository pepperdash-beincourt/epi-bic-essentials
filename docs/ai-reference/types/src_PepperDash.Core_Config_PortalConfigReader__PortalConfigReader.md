...
| Source file | [`src/PepperDash.Core/Config/PortalConfigReader.cs`](../../../src/PepperDash.Core/Config/PortalConfigReader.cs) |
| Language | C# |
| Declaration | `class PortalConfigReader` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Core.Config` |

## What

`PortalConfigReader` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `ReadAndMergeFileIfNecessary`, `MergeConfigs`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
