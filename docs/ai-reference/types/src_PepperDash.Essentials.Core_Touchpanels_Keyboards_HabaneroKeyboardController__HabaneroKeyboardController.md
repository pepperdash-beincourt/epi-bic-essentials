...
| Language | C# |
| Declaration | `class HabaneroKeyboardController` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Touchpanels.Keyboards` |

## What

`HabaneroKeyboardController` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
