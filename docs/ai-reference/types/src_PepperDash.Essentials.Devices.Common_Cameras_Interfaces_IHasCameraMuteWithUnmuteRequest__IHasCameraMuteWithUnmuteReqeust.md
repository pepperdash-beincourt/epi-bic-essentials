...
| Source file | [`src/PepperDash.Essentials.Devices.Common/Cameras/Interfaces/IHasCameraMuteWithUnmuteRequest.cs`](../../../src/PepperDash.Essentials.Devices.Common/Cameras/Interfaces/IHasCameraMuteWithUnmuteRequest.cs) |
| Language | C# |
| Declaration | `interface IHasCameraMuteWithUnmuteReqeust` with declared base/contract list `IHasCameraMute` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Cameras` |

## What

`IHasCameraMuteWithUnmuteReqeust` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Preserve the declared inheritance/contract relationship: `IHasCameraMute`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
