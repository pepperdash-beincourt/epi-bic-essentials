# IProcessorExtensionDeviceFactory
...
| Source file | [`src/PepperDash.Essentials.Core/Factory/IProcessorExtensionDeviceFactory.cs`](../../../src/PepperDash.Essentials.Core/Factory/IProcessorExtensionDeviceFactory.cs) |
| Language | C# |
| Declaration | `interface IProcessorExtensionDeviceFactory` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`IProcessorExtensionDeviceFactory` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
