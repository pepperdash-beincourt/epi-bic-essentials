...
| Source file | [`src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IHasMuteControl.cs`](../../../src/PepperDash.Essentials.Core/DeviceTypeInterfaces/IHasMuteControl.cs) |
| Language | C# |
| Declaration | `interface IHasMuteControl` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`IHasMuteControl` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
