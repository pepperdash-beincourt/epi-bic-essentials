...
| Source file | [`src/PepperDash.Essentials.Devices.Common/VideoCodec/Interfaces/MeetingInfo.cs`](../../../src/PepperDash.Essentials.Devices.Common/VideoCodec/Interfaces/MeetingInfo.cs) |
| Language | C# |
| Declaration | `class MeetingInfo` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.VideoCodec.Interfaces` |

## What

`MeetingInfo` is a structured representation of data exchanged between components. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
