...
| Source file | [`src/PepperDash.Essentials.Core/Devices/CameraListItem.cs`](../../../src/PepperDash.Essentials.Core/Devices/CameraListItem.cs) |
| Language | C# |
| Declaration | `class CameraListItem` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`CameraListItem` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
