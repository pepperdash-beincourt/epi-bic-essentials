...
| Source file | [`src/PepperDash.Essentials.Core/Devices/IDspPresetsDirectRecall.cs`](../../../src/PepperDash.Essentials.Core/Devices/IDspPresetsDirectRecall.cs) |
| Language | C# |
| Declaration | `interface IDspPresetsDirectRecall` with declared base/contract list `IKeyed` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`IDspPresetsDirectRecall` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
