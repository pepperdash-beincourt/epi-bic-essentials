# DisableAllStreamDebugRequestHandler
...
| Source file | [`src/PepperDash.Essentials.Core/Web/RequestHandlers/DisableAllStreamDebugRequestHandler.cs`](../../../src/PepperDash.Essentials.Core/Web/RequestHandlers/DisableAllStreamDebugRequestHandler.cs) |
| Language | C# |
| Declaration | `class DisableAllStreamDebugRequestHandler` with declared base/contract list `WebApiBaseRequestHandler` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Web.RequestHandlers` |

## What

`DisableAllStreamDebugRequestHandler` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
