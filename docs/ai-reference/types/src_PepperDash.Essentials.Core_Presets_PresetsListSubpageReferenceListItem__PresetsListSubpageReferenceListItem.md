# PresetsListSubpageReferenceListItem
...
| Source file | [`src/PepperDash.Essentials.Core/Presets/PresetsListSubpageReferenceListItem.cs`](../../../src/PepperDash.Essentials.Core/Presets/PresetsListSubpageReferenceListItem.cs) |
| Language | C# |
| Declaration | `class PresetsListSubpageReferenceListItem` with declared base/contract list `SubpageReferenceListItem` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Presets` |

## What

`PresetsListSubpageReferenceListItem` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Preserve the declared inheritance/contract relationship: `SubpageReferenceListItem`. Public methods declared in this source file include: `Clear`, `Refresh`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
