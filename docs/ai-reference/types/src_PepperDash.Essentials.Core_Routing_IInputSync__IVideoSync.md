...
| Source file | [`src/PepperDash.Essentials.Core/Routing/IInputSync.cs`](../../../src/PepperDash.Essentials.Core/Routing/IInputSync.cs) |
| Language | C# |
| Declaration | `interface IVideoSync` with declared base/contract list `IKeyed` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Routing` |

## What

`IVideoSync` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
