# EssentialsRoomScheduledEventsConfig
...
| Language | C# |
| Declaration | `class EssentialsRoomScheduledEventsConfig` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Room.Config` |

## What

`EssentialsRoomScheduledEventsConfig` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
