...
| Source file | [`src/PepperDash.Essentials.MobileControl.Messengers/MobileControlMessage.cs`](../../../src/PepperDash.Essentials.MobileControl.Messengers/MobileControlMessage.cs) |
| Language | C# |
| Declaration | `class MobileControlMessage` with declared base/contract list `IMobileControlMessage` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.AppServer.Messengers` |

## What

`MobileControlMessage` is a structured representation of data exchanged between components. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Preserve the declared inheritance/contract relationship: `IMobileControlMessage`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
