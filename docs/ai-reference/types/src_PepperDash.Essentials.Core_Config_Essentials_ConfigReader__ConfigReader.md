...
| Source file | [`src/PepperDash.Essentials.Core/Config/Essentials/ConfigReader.cs`](../../../src/PepperDash.Essentials.Core/Config/Essentials/ConfigReader.cs) |
| Language | C# |
| Declaration | `class ConfigReader` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Config` |

## What

`ConfigReader` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `LoadConfig`, `GetConfigFiles`, `GetGroupForDeviceKey`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
