...
| Language | C# |
| Declaration | `class ApiAttribute` with declared base/contract list `Attribute` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`ApiAttribute` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
