...
| Source file | [`src/PepperDash.Essentials.Core/Factory/DeviceFactory.cs`](../../../src/PepperDash.Essentials.Core/Factory/DeviceFactory.cs) |
| Language | C# |
| Declaration | `class DeviceFactory` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`DeviceFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `AddFactoryForType`, `GetDevice`, `GetDeviceFactoryTypes`, `GetDeviceFactoryDictionary`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
