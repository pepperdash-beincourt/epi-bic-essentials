...
| Source file | [`src/PepperDash.Essentials.Devices.Common/Codec/Interfaces/ICodecCallControls.cs`](../../../src/PepperDash.Essentials.Devices.Common/Codec/Interfaces/ICodecCallControls.cs) |
| Language | C# |
| Declaration | `interface ICodecCallControls` with declared base/contract list `IHasDialer` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Codec` |

## What

`ICodecCallControls` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
