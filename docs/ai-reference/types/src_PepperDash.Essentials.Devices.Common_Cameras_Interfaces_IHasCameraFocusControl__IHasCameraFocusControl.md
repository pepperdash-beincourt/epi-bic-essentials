...
| Source file | [`src/PepperDash.Essentials.Devices.Common/Cameras/Interfaces/IHasCameraFocusControl.cs`](../../../src/PepperDash.Essentials.Devices.Common/Cameras/Interfaces/IHasCameraFocusControl.cs) |
| Language | C# |
| Declaration | `interface IHasCameraFocusControl` with declared base/contract list `IHasCameraControls` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Cameras` |

## What

`IHasCameraFocusControl` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
