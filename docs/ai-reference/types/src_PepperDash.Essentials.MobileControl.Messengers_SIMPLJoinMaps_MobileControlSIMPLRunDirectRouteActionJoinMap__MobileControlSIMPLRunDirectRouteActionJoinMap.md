...
| Source file | [`src/PepperDash.Essentials.MobileControl.Messengers/SIMPLJoinMaps/MobileControlSIMPLRunDirectRouteActionJoinMap.cs`](../../../src/PepperDash.Essentials.MobileControl.Messengers/SIMPLJoinMaps/MobileControlSIMPLRunDirectRouteActionJoinMap.cs) |
| Language | C# |
| Declaration | `class MobileControlSIMPLRunDirectRouteActionJoinMap` with declared base/contract list `JoinMapBaseAdvanced` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.AppServer` |

## What

`MobileControlSIMPLRunDirectRouteActionJoinMap` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
