...
| Source file | [`src/PepperDash.Essentials.MobileControl/WebSocketServer/UiClient.cs`](../../../src/PepperDash.Essentials.MobileControl/WebSocketServer/UiClient.cs) |
| Language | C# |
| Declaration | `class UiClient` with declared base/contract list `WebSocketBehavior, IKeyed` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.WebSocketServer` |

## What

`UiClient` is a focused service boundary that isolates a collaboration, transport, or data responsibility. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Preserve the declared inheritance/contract relationship: `WebSocketBehavior, IKeyed`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
