...
| Source file | [`src/PepperDash.Essentials.Devices.Common/AudioCodec/Interfaces/IDtmfDecode.cs`](../../../src/PepperDash.Essentials.Devices.Common/AudioCodec/Interfaces/IDtmfDecode.cs) |
| Language | C# |
| Declaration | `class DtmfReceivedEventArgs` with declared base/contract list `EventArgs` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.AudioCodec` |

## What

`DtmfReceivedEventArgs` is an event payload type that carries state-change information between collaborators. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
