...
| Language | C# |
| Declaration | `class LayoutChangedDto` |
| Accessibility | `private` |
| Namespace/module | `PepperDash.Essentials.Core.Web` |

## What

`LayoutChangedDto` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
