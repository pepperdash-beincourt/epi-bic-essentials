...
| Source file | [`src/PepperDash.Core/Adapters/CrestronConsoleAdapter.cs`](../../../src/PepperDash.Core/Adapters/CrestronConsoleAdapter.cs) |
| Language | C# |
| Declaration | `class CrestronConsoleAdapter` with declared base/contract list `PdCore.ICrestronConsole` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Core.Adapters` |

## What

`CrestronConsoleAdapter` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
