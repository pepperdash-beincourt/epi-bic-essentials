...
| Source file | [`src/PepperDash.Essentials.Core/SmartObjects/SubpageReferencList/SubpageReferenceList.cs`](../../../src/PepperDash.Essentials.Core/SmartObjects/SubpageReferencList/SubpageReferenceList.cs) |
| Language | C# |
| Declaration | `class SubpageReferenceList` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core` |

## What

`SubpageReferenceList` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `AddItem`, `Clear`, `Refresh`, `GetBoolFeedbackSig`, `GetUShortOutputSig`, `GetStringOutputSig`, `BoolInputSig`, `UShortInputSig`, `StringInputSig`, `SRL_SigChange`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
