...
| Source file | [`src/PepperDash.Core/Conversion/Convert.cs`](../../../src/PepperDash.Core/Conversion/Convert.cs) |
| Language | C# |
| Declaration | `class EncodingHelper` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Core` |

## What

`EncodingHelper` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `ConvertUtf8ToAscii`, `ConvertUtf8ToUtf16`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
