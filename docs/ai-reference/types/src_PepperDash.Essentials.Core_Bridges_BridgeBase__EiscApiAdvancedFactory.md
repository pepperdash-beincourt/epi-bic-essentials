...
| Language | C# |
| Declaration | `class EiscApiAdvancedFactory` with declared base/contract list `EssentialsDeviceFactory<EiscApiAdvanced>` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Bridges` |

## What

`EiscApiAdvancedFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
