...
| Source file | [`src/PepperDash.Essentials.Devices.Common/Shades/ShadeBase.cs`](../../../src/PepperDash.Essentials.Devices.Common/Shades/ShadeBase.cs) |
| Language | C# |
| Declaration | `class ShadeBase` with declared base/contract list `EssentialsDevice, IShadesOpenCloseStop` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.Shades` |

## What

`ShadeBase` is a device-model type that owns lifecycle, controls, feedback, or communication responsibilities. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
