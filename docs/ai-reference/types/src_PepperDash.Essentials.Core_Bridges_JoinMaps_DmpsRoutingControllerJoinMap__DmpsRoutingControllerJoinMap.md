...
| Source file | [`src/PepperDash.Essentials.Core/Bridges/JoinMaps/DmpsRoutingControllerJoinMap.cs`](../../../src/PepperDash.Essentials.Core/Bridges/JoinMaps/DmpsRoutingControllerJoinMap.cs) |
| Language | C# |
| Declaration | `class DmpsRoutingControllerJoinMap` with declared base/contract list `JoinMapBaseAdvanced` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Bridges` |

## What

`DmpsRoutingControllerJoinMap` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
