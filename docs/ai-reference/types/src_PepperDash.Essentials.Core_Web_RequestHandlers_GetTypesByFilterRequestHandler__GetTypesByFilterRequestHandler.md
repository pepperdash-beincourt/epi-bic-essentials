# GetTypesByFilterRequestHandler
...
| Source file | [`src/PepperDash.Essentials.Core/Web/RequestHandlers/GetTypesByFilterRequestHandler.cs`](../../../src/PepperDash.Essentials.Core/Web/RequestHandlers/GetTypesByFilterRequestHandler.cs) |
| Language | C# |
| Declaration | `class GetTypesByFilterRequestHandler` with declared base/contract list `WebApiBaseRequestHandler` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.Web.RequestHandlers` |

## What

`GetTypesByFilterRequestHandler` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
