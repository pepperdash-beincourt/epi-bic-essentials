...
| Source file | [`src/PepperDash.Essentials.Devices.Common/SoftCodec/GenericSoftCodecFactory.cs`](../../../src/PepperDash.Essentials.Devices.Common/SoftCodec/GenericSoftCodecFactory.cs) |
| Language | C# |
| Declaration | `class GenericSoftCodecFactory` with declared base/contract list `EssentialsDeviceFactory<GenericSoftCodec>` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Devices.Common.SoftCodec` |

## What

`GenericSoftCodecFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
