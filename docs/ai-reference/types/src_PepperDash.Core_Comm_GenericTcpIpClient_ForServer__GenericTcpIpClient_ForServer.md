...
| Source file | [`src/PepperDash.Core/Comm/GenericTcpIpClient_ForServer.cs`](../../../src/PepperDash.Core/Comm/GenericTcpIpClient_ForServer.cs) |
| Language | C# |
| Declaration | `class GenericTcpIpClient_ForServer` with declared base/contract list `Device, IAutoReconnect` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Core` |

## What

`GenericTcpIpClient_ForServer` is a device-model type that owns lifecycle, controls, feedback, or communication responsibilities. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
