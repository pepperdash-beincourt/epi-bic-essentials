...
| Source file | [`src/PepperDash.Essentials.Core/DeviceTypeInterfaces/ITvPresetsProvider.cs`](../../../src/PepperDash.Essentials.Core/DeviceTypeInterfaces/ITvPresetsProvider.cs) |
| Language | C# |
| Declaration | `interface ITvPresetsProvider` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Core.DeviceTypeInterfaces` |

## What

`ITvPresetsProvider` is a contract that callers and implementations use to agree on behavior. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
